    ...
    <div class="container">
        <div class="row">
            <div class="ajout admin2">
                <h2 class="titre2"><strong> Ajouter nouveau compteur</strong></h2>
                <form action="<?php echo 'deb.php?controller=Compteur&action=store'?>" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="help-inline"><?php echo $errors['codeCli']; ?></span>
                                </div>
                            </div>
                            <div class="col-md-6">
