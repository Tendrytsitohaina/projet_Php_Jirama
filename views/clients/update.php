    ...
    <div class="container">
        <div class="row">
            <div class="ajout admin2">
                <h2 class="titre2"><strong> Modifier l'enregistrement du client</strong></h2>
                <form action="<?php echo 'deb.php?controller=customer&action=update&codeCli='.$codeCli.''?>" method="post">
