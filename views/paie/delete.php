    ...
    <div class="container">
        <div class="row">
            <div class="ajout admin2">
                <h2 class="titre2"><strong> Supprimer un paiement</strong></h2>
                <form action=" <?php echo 'deb.php?controller=Paie&action=delete&codePaie=' .$codePaie.'' ?>" method="POST">
                    <input type="hidden" value="<?php echo $codePaie ?>" name="codePaie">
                    <p class="alert alert-warning">
                        Voulez-vous vraiment supprimer ce paiement: <br>
                        Code du paiement: <?php echo $codePaie; ?>
                    </p>
                    <div class="form-actions">
                        <button type="submit" class="btn btn-danger" > Oui </button>
                        <a href="deb.php?controller=Paie&action=index" class="btn btn-default"> Non </a>
                    </div>
                </form>
            </div>
        </div>
