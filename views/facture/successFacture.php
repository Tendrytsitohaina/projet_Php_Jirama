    ...
    <div class="container">
        <div class="row">
            <div class="ajout admin2">
                <h2 class="titre2"><strong> Facture Ajoutée avec succès</strong></h2>
                <p class="alert alert-warning">
                     <?php echo "Facture générée : <a href='views/facture/factures/{$codeCli}_{$nom}/$pdfFilename' target='blank'> $pdfFilename </a>"; ?>
                </p>
