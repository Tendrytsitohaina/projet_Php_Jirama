    ...
    <div class="container">
        <div class="row">
            <div class="ajout admin2">
                <h2 class="titre2"><strong> Supprimer un rélévé d'Elec</strong></h2>
                <form action=" <?php echo 'deb.php?controller=Elec&action=delete&codeElec=' .$codeElec.'' ?>" method="POST">
                    <input type="hidden" value="<?php echo $codeElec;?>" name="codeComp">
                    <p class="alert alert-warning">
                        Voulez-vous vraiment supprimer ce rélévé: <br>
                        Code du Rélévé: <?php echo $codeElec; ?>
                    </p>
                    <div class="form-actions">
                        <button type="submit" class="btn btn-danger" > Oui </button>
                        <a href="deb.php?controller=Elec&action=index" class="btn btn-default"> Non </a>
                    </div>
                </form>
            </div>
        </div>
