    ...
    <div class="container">
        <div class="row">
            <div class="ajout admin2">
                <h2 class="titre2"><strong> Modifier un Rélévé d' Elec</strong></h2>
                <form action="<?php echo 'deb.php?controller=Elec&action=update&codeElec='.$codeElec.''?>" method="post">
                    <div class="containerPers">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="codeComp">Code Elec</label>
                                    <input type="text" name="codeComp" class="form-control" id="codeComp" placeholder="Entrer le code Compteur..." value="<?php echo $codeElec?>" disabled>
                                </div>
                            </div> 
                        </div>
