...
<body>
    <div class="dashboard">
                ...
                <div class="left_content col-md-12">
                    ...
                    <div class="navigation">
                        <ul>
                            ...
                            <li><a href="#" id="active" class="btn btn-danger">Rélévé d' éléc</a></li>
        ...
        <div class="right_panel">
            <header class="loha1"> 
                <h2>Elec <a href="deb.php?controller=Elec&action=create" class="btn btn-success" id="ajouter"><img src="image/icons8_create_50px.png" alt="" class="icon"> Ajouter</a></h2>
                <div class="search">
                    <form action="deb.php?controller=search&action=searchElec" method="POST">
                        <select name="typeSearch" class="form-control2" id="sexe">
                            <option value="codeElec" <?= ($search['typeSearch'] == "codeEau") ? 'selected' : ''?>>Code Elec</option>
                        ...
                        <a href="deb.php?controller=Elec&action=index" class="btn btn-default">Refresh</a>
                    </form>
                </div>
            </header>
            <div class="right_content">
                <div class="containerPers admin">
                    <div class="row">
                        <h3><strong>Liste des rélevés d'Elec</strong></h3>
                                ...
                                <?php
                                    if ($item) {
                                        foreach($item as $item){
                                            ...
                                            echo        '<td>' . $item['codeElec']. '</td>';
                                            echo        '<td>' . $item['dateReleve1']. '</td>';
                                            echo        '<td>' . $item['valeur1']. '</td>';
                                            echo        '<td>' . $item['date_presentation'] . '</td>';
                                            echo        '<td>' . $item['date_limite'] . '</td>';
                                            echo        '<td>' . $item['codeCompteur']. '</td>';
                                            echo        '<td>';
                                            echo            '<a href="deb.php?controller=Elec&action=createUpdate&codeElec='. $item['codeElec'] .'" class="btn btn-primary"><img src="image/icons8_edit_50px.png" class="icon"></a>';
                                            echo ' ';
                                            echo            '<a href="deb.php?controller=Elec&action=createDelete&codeElec='. $item['codeElec'] .'" class="btn btn-danger"><img src="image/icons8_trash_can_50px.png" alt="" class="icon"></a>';
                                            echo        '</td>';
                                            echo '</tr>';
                                        }
                                    }else {
